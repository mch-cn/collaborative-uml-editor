 ...
 * @param {mxWindow} wnd the mxWindow-object otherwise it will be created
 * @return {mxWindow} returns the mxWindow-object
...
function UserList(user, visible, wnd) {
     ...
     */
    var getUserEntry = (userId, userName, imageUrl, color) => {
