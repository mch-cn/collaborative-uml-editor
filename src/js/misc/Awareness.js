 ...
 * @module Misc
 */
import { mxEvent, mxCellHighlight, mxPoint } from './mxExport.js';
...
function Awareness(wireframe) {
    ...
    wireframe.getSelectionModel().addListener(mxEvent.CHANGE, (sender, evt) => {
    ...
    y.share.awareness.observe(event => {
