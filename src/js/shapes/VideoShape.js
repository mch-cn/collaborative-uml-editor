 ...
 * @see VideoPlayer
 */
class VideoShape extends mxShape {
    ...
    paintVertexShape(c, x, y, w, h) {
        ...
        var buttonColor = mxUtils.getValue(this.style, VideoShape.cst.FILL_COLOR2, 'grey');
        var frameColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, 'grey');
        var filledColor = mxUtils.getValue(this.style, VideoShape.cst.STROKE_COLOR2, 'grey');
        var emptyColor = mxUtils.getValue(this.style, VideoShape.cst.STROKE_COLOR3, 'grey');
        var barHeight = mxUtils.getValue(this.style, VideoShape.cst.BAR_HEIGHT, 30);
    ...
    foreground(c, x, y, w, h, bgColor, frameColor){
    ...
    otherShapes(c, x, y, w, h, buttonColor, frameColor, filledColor, emptyColor, barHeight) {
        var barPos = mxUtils.getValue(this.style, VideoShape.cst.BAR_POS, '20');
        ...
        var textColor = mxUtils.getValue(this.style, VideoShape.cst.TEXT_COLOR, 'grey');
        c.begin();
